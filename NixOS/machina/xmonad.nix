...

{
   ...
   --  └──────────────────────────────────────────────────────────┘ --
        ...
        myNormColor   = "${config.colors.background_dark}"
   ...
   --  └──────────────────────────────────────────────────────────┘ --
        ...
        arcXPConfig = def
              { font                = myFont
              , bgColor             = "${config.colors.background_dark}"
              , fgColor             = "${config.colors.foreground_dark}"
              , bgHLight            = "${config.colors.foreground_dark}"
              , fgHLight            = "${config.colors.background_dark}"
   ...
   --  └──────────────────────────────────────────────────────────┘ --
        ...
        myTabTheme = def { fontName            = myFont
                         , activeColor         = "${config.colors.foreground_dark}"
                         , inactiveColor       = "${config.colors.background_dark}"
                         , activeBorderColor   = "${config.colors.foreground_dark}"
                         , inactiveBorderColor = "${config.colors.background_dark}"
                         , activeTextColor     = "${config.colors.background_dark}"
                         , inactiveTextColor   = "${config.colors.foreground_dark}"
                         }
        ...
        myShowWNameTheme = def
            ...
            , swn_fade              = 0.4
            , swn_bgcolor           = "${config.colors.background_dark}"
            , swn_color             = "${config.colors.foreground_dark}"
            }
