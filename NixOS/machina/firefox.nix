    ...
    profiles.default = {
      ...
      userChrome = ''
        :root {
          ...
          --mff-bg                    : ${config.colors.background_dark};
          --mff-fg                    : ${config.colors.foreground_dark};
          --mff-icon-color            : ${config.colors.foreground_dark};
          --mff-nav-toolbar-padding   : 8px;
          --mff-sidebar-bg            : var(--mff-bg);
          --mff-sidebar-fg            : var(--mff-fg);
          --mff-sidebar-color         : ${config.colors.foreground_dark};
       
          --mff-tab-border-radius     : 0px;
          --mff-tab-color             : ${config.colors.foreground_dark};
          ...
          --mff-urlbar-color          : ${config.colors.foreground_dark};
          --mff-urlbar-focused-color  : ${config.colors.foreground_dark};
          --mff-urlbar-font-family    : ${config.schema.font}, serif;
          --mff-urlbar-font-size      : 12pt;
          --mff-urlbar-font-weight    : 700;

          --mff-urlbar-results-color       : ${config.colors.foreground_dark};
          ...
          --mff-urlbar-results-url-color   : ${config.colors.foreground_dark};
        ...
        */
        ...
        #tabbrowser-tabs {
          --tab-loading-fill: ${config.colors.foreground_dark} !important;
        }
       ...
       ::selection {
         background-color: ${config.colors.background_dark};
        ...
        */
        ...
        td {
            color: ${config.colors.background_dark};
            width: 100%;
        }
